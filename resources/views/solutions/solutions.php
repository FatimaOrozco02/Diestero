        ...
        <section style="background: linear-gradient(rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.55)), url('<?php echo $baseUrl ?>img/banner 2.jpg') no-repeat center center; background-size: cover; min-height: 140px;" class="d-flex align-items-center border-bottom border-light">
            <div class="container-fluid px-3 px-md-5 py-4 text-center text-md-start">
                ...
                <div class="mx-auto" style="max-width: 1440px; width: 100%;">
                    <h1 class="text-uppercase mb-1 fw-bold " style="color: #8D3C45; font-size: 2.2rem; letter-spacing: 1px;">SOLUCIONES ESTRATÉGICAS</h1>
                    ...
                    <div class="row g-4 pb-5">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="card h-100 border text-center bg-white shadow-sm p-3 interactive-card custom-card-border" style="min-height: 380px; cursor:pointer;" data-target="acquisitions">
                                <div class="mb-4 bg-light position-relative" style="height: 160px; overflow: visible;">
                                    <img src="<?php echo $baseUrl ?>img/Fusiones y Adquisiciones.jpg" alt="Fusiones" class="img-fluid w-100 h-100 object-fit-cover">

                                    <div class="position-absolute start-50 translate-middle rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="bottom: -66px; width: 72px; height: 72px; background-color: #1E355E; border: 4px solid #ffffff; z-index: 2;">
                                        <i class="fa-solid fa-handshake-angle text-white fs-4"></i>
                                    </div>
                                </div>
                                <div class="card-body p-0 d-flex flex-column justify-content-between mt-5">
                                    <h5 class="text-uppercase mb-3" style="color: #1E355E; font-size: 1.05rem; letter-spacing: 0.5px;">Fusiones y Adquisiciones</h5>
                                    <p class="text-muted small mb-0 lh-sm">Impulsamos el crecimiento mediante operaciones estratégicas de compra, venta y expansión empresarial.</p>
                                </div>
                            </div>
                        </div>

                        <!-- Tarjeta 2: Capital y Financiamiento -->
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="card h-100 border text-center bg-white shadow-sm p-3 interactive-card custom-card-border" style="min-height: 380px; cursor:pointer;" data-target="financing">
                                <div class="mb-4 bg-light position-relative" style="height: 160px; overflow: visible;">
                                ...
                                <div class="card-body p-0 d-flex flex-column justify-content-between mt-5">
                                    <h5 class="text-uppercase mb-3" style="color: #1E355E; font-size: 1.05rem; letter-spacing: 0.5px;">Capital y Financiamiento</h5>
                                    <p class="text-muted small mb-0 lh-sm">Conectamos tu empresa con las mejores alternativas de inversión y financiamiento.</p>
                                </div>
                            </div>
                        </div>

                        <!-- Tarjeta 3: Impulso Empresarial -->
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="card h-100 border text-center bg-white shadow-sm p-3 interactive-card custom-card-border" style="min-height: 380px; cursor:pointer;" data-target="business">
                                <div class="mb-4 bg-light position-relative" style="height: 160px; overflow: visible;">
                                    <img src="<?php echo $baseUrl ?>img/Impulso Empresarial.jpg" alt="Impulso" class="img-fluid w-100 h-100 object-fit-cover">

                                    <div class="position-absolute start-50 translate-middle rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="bottom: -66px; width: 72px; height: 72px; background-color: #1E355E; border: 4px solid #ffffff; z-index: 2;">
                                        <i class="fa-brands fa-space-awesome text-white fs-4"></i>
                                    </div>
                                </div>
                                <div class="card-body p-0 d-flex flex-column justify-content-between mt-5">
                                    <h5 class="text-uppercase mb-3" style="color: #1E355E; font-size: 1.05rem; letter-spacing: 0.5px;">Impulso Empresarial</h5>
                                    <p class="text-muted small mb-0 lh-sm">Acompañamiento financiero continuo para fortalecer la toma de decisiones y acelerar resultados.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Tarjeta 4: Pharma -->
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="card h-100 border text-center bg-white shadow-sm p-3 interactive-card custom-card-border" style="min-height: 380px; cursor:pointer;" data-target="pharma">
                                <div class="mb-4 bg-light position-relative" style="height: 160px; overflow: visible;">
                                    <img src="<?php echo $baseUrl ?>img/pharma.jpg" alt="Pharma" class="img-fluid w-100 h-100 object-fit-cover">

                                    <div class="position-absolute start-50 translate-middle rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="bottom: -66px; width: 72px; height: 72px; background-color: #1E355E; border: 4px solid #ffffff; z-index: 2;">
                                        <i class="fa-solid fa-capsules text-white fs-4"></i>
                                    </div>
                                </div>
                                <div class="card-body p-0 d-flex flex-column justify-content-between mt-5">
                                    <h5 class="text-uppercase mb-3" style="color: #1E355E; font-size: 1.05rem; letter-spacing: 0.5px;">Pharma</h5>
                                    <p class="text-muted small mb-0 lh-sm">Contamos con experiencia en el desarrollo, crecimiento y fortalecimiento de empresas del sector salud y farmacéutico.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="w-100 view-section d-none" id="acquisitions">
    <section style="background: linear-gradient(rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.55)), url('<?php echo $baseUrl ?>img/banner 2.jpg') no-repeat center center; background-size: cover; min-height: 140px;" class="d-flex align-items-center border-bottom border-light">
        <div class="container-fluid px-3 px-md-5 py-4 text-center text-md-start">
            <div  class="mx-auto" style="max-width: 1440px; width: 100%;">
                <h1 class="text-uppercase mb-1 fw-bold" style="color: #8D3C45; font-size: 2.2rem; letter-spacing: 1px;">FUSIONES Y ADQUISICIONES</h1>
                <h5 class="text-uppercase mb-0 fw-bold" style="color: #1E355E; font-size: 0.95rem; letter-spacing: 0.5px;">SOLUCIONES DISEÑADAS PARA IMPULSAR TU ORGANIZACIÓN</h5>
            </div>
        </div>
    </section>
...
<div class="w-100 view-section d-none" id="financing">
    <section style="background: linear-gradient(rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.55)), url('<?php echo $baseUrl ?>img/banner 2.jpg') no-repeat center center; background-size: cover; min-height: 140px;" class="d-flex align-items-center border-bottom border-light">
        <div class="container-fluid px-3 px-md-5 py-4 text-center text-md-start">
            <div class="mx-auto" style="max-width: 1440px; width: 100%;">
                <h1 class="text-uppercase mb-1 fw-bold" style="color: #8D3C45; font-size: 2.2rem; letter-spacing: 1px;">CAPITAL Y FINANCIAMIENTO</h1>
                <h5 class="text-uppercase mb-0 fw-bold" style="color: #1E355E; font-size: 0.95rem; letter-spacing: 0.5px;">SOLUCIONES DISEÑADAS PARA IMPULSAR TU ORGANIZACIÓN</h5>
            </div>
        </div>
    </section>
...
<div class="w-100 view-section d-none" id="business">
    <section style="background: linear-gradient(rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.55)), url('<?php echo $baseUrl ?>img/banner 2.jpg') no-repeat center center; background-size: cover; min-height: 140px;" class="d-flex align-items-center border-bottom border-light">
        <div class="container-fluid px-3 px-md-5 py-4 text-center text-md-start">
            <div class="mx-auto" style="max-width: 1440px; width: 100%;">
                <h1 class="text-uppercase mb-1 fw-bold" style="color: #8D3C45; font-size: 2.2rem; letter-spacing: 1px;">IMPULSO EMPRESARIAL</h1>
                <h5 class="text-uppercase mb-0 fw-bold" style="color: #1E355E; font-size: 0.95rem; letter-spacing: 0.5px;">SOLUCIONES DISEÑADAS PARA IMPULSAR TU ORGANIZACIÓN</h5>
            </div>
        </div>
    </section>
...
<!-- 4. PHARMA -->
<div class="w-100 view-section d-none" id="pharma">
    <!-- Banner superior angosto y compacto -->
    <section style="background: linear-gradient(rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.55)), url('<?php echo $baseUrl ?>img/banner 2.jpg') no-repeat center center; background-size: cover; min-height: 140px;" class="d-flex align-items-center border-bottom border-light">
        <div class="container-fluid px-3 px-md-5 py-4 text-center text-md-start">
            <div class="mx-auto" style="max-width: 1440px; width: 100%;">
                <h1 class="text-uppercase mb-1 fw-bold" style="color: #8D3C45; font-size: 2.2rem; letter-spacing: 1px;">PHARMA</h1>
                <h5 class="text-uppercase mb-0 fw-bold" style="color: #1E355E; font-size: 0.95rem; letter-spacing: 0.5px;">SOLUCIONES ESPECIALIZADAS PARA LA INDUSTRIA FARMACÉUTICA Y CIENCIAS DE LA VIDA</h5>
            </div>
        </div>
    </section>
