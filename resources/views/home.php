            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-md-6 text-muted" style="font-size: 0.92rem;">
                    ...
                    <ul class="list-unstyled mb-4 d-flex flex-column gap-2 ps-2">
                        ...
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Obtención de capital y financiamiento
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Fusiones y adquisiciones
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Gobierno corporativo
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Reestructuración empresarial
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Implementación de sistemas de gestión
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Certificaciones internacionales
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="fa-solid fa-circle-check text-danger fs-6"></i> Desarrollo y fortalecimiento organizacional
                        </li>
                    </ul>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-md-7 text-muted" style="font-size: 0.92rem;">
                    ...
                    <ul class="mb-4 ps-4" style="color: #4a4a4a;">
                        ...
                        <li class="mb-1">Latinoamérica</li>
                    </ul>
                </div>
            </div>
