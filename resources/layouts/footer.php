        ...
        <div class="row align-items-center position-relative" style="min-height: 180px;">
            ...
            <div class="col-12 col-lg-4 text-center position-relative d-flex align-items-center justify-content-center mb-3 mb-lg-0">
                ...
                <div class="h-100 d-none d-lg-inline-block" style="-webkit-mask-image: linear-gradient(to right, transparent 0%, black 20%, black 80%, transparent 100%);
                    ...
                    <img src="<?php echo $baseUrl ?>img/banner diestro footer copia.jpg" alt="Diestro" class="img-fluid object-fit-contain" style="max-height: 180px;">
                </div>
...
<footer class="text-white p-0 position-relative w-100 overflow-hidden" 
        style="min-height: 260px; height: auto; background-color: #000;">
   
    
    <div class="position-absolute top-0 start-0 w-100 h-100 d-none d-lg-block" 
         style="background: url('<?php echo $baseUrl ?>img/banner diestro footer copia.jpg') center center / contain no-repeat;">
    </div>
   
    
    <div class="container-fluid px-3 px-md-5 position-relative z-1" style="max-width: 1440px;">
        
       
        <div class="row align-items-center justify-content-center justify-content-lg-start" 
             style="min-height: 140px; @media (min-width: 992px) { min-height: 260px; }">
            
           
            <div class="col-12 col-lg-4 text-center text-lg-start py-4 py-lg-0">
                <div class="mx-auto mx-lg-0" style="max-width: 160px;">
                   <img src="<?php echo $baseUrl ?>img/logo diestro_1200px_blanco.png" alt="Diestro Fortalecemos Negocios" class="img-fluid">
                </div>
            </div>
