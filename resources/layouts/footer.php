<footer class="bg-black text-white p-0 overflow-hidden font-sans-serif" style="height: 180px;">
    ...
    <div class="container-fluid px-5 h-100">
        ...
        <div class="row align-items-center h-100 position-relative">
            ...
            <div class="col-4 h-100 text-center position-relative">
                <div class="h-100 d-inline-block" style="
                    /* Máscara CSS para difuminar los lados izquierdo y derecho */
